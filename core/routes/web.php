...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        // Users Manager
        Route::resource('user-admin', 'UserAdminController')->except(['show', 'destroy']);
        ...
        Route::prefix('store')
            ...
            ->group(function () {
                ...
                Route::get('/ticket-search', 'ticketSearch')->name('ticket-search');
                Route::get('/ticket/{id}/{slug}', 'showSeat')->name('show-seat');
        ...
        */
        ...
        Route::name('trip.')->prefix('manage')->group(function(){
            ...
            Route::get('route/check', 'ManageTripController@routeCheck')->name('check');
