            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.store*',3)}}">
                        <i class="menu-icon las la-laptop"></i>
                        <span class="menu-title">@lang('Counter')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.store*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.store.users')}} ">
                                <a href="{{route('admin.store.users')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Users')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.store.ticket')}}">
                                <a href="{{route('admin.store.ticket')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Ticket')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.store.bookings')}}">
                                <a href="{{route('admin.store.bookings')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Booking')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.store.payments')}}">
                                <a href="{{route('admin.store.payments')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.user-admin.index')}}">
                    <a href="{{route('admin.user-admin.index')}}" class="nav-link">
                        <i class="menu-icon las la-users"></i>
                        <span class="menu-title">@lang('User Admin')</span>
                    </a>
                </li>
