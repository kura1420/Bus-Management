...
if ($action == 'requirements') {
	...
	if ($requiredPHP ==  $currentPHP) {
		$passed[] = 'PHP version 7.4 is required';
	} else {
		$failed[] = 'PHP version 7.4 is required. Your current PHP version is ' . $currentPHP;
	}
	$extensions = ['BCMath', 'Ctype', 'cURL', 'DOM', 'Fileinfo', 'GD', 'JSON', 'Mbstring', 'OpenSSL', 'PCRE', 'PDO', 'pdo_mysql', 'Tokenizer', 'XML','gmp'];
...
<body>
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				<img class="logo" src="https://doniaweb.com/uploads/monthly_2021_08/logo.webp.ef3c02692000fd75f993e5d9f1342ddd.webp" alt="ViserLab">
				...
				<div class="install-content-area">
					<div class="install-item">
						...
						<div class="box-item">
							...
							?>
								<div class="item">
									<h4 class="subtitle">This license is issued by the DoniaWeB community, and you can use it as you like</h4>
									
									<ul class="check-list">
										<li> Licensed By DoniaWeB. </li>
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://doniaweb.com/">DoniaWeB</a></p>
		</div>
	</footer>
